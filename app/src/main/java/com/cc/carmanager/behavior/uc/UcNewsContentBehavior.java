package com.cc.carmanager.behavior.uc;
...
import com.cc.carmanager.behavior.helper.HeaderScrollingViewBehavior;
...
public class UcNewsContentBehavior extends HeaderScrollingViewBehavior {
    ...
    private void offsetChildAsNeeded(CoordinatorLayout parent, View child, View dependency) {
        child.setTranslationY((int) (-dependency.getTranslationY() / (getHeaderOffsetRange() * 1.0f) * getScrollRange(dependency)) + MyApplication.getContext().getResources().getDimensionPixelOffset(R.dimen.uc_news_header_title_height));
    }
    ...
    private int getHeaderOffsetRange() {
        return MyApplication.getContext().getResources().getDimensionPixelOffset(R.dimen.uc_news_header_pager_offset);
    }
