...
public class CarsSellerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{

    private final LayoutInflater mLayoutInflater;
    private final Context mContext;
    private RecyclerView recyclerView;
    private ArrayList<CarsSellerBean> listItem;

    public CarsSellerAdapter(Context context, ArrayList<CarsSellerBean> listItem, RecyclerView recyclerView) {
        mContext = context;
