...
public class CarsDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public CarsDetailAdapter(Context context, ArrayList<CarsItemBean> listItem, RecyclerView recyclerView) {
        mContext = context;
    ...
    public static class CarViewHolder extends RecyclerView.ViewHolder {
        ...
        CarViewHolder(View view) {
            ...
            tvLetter = (TextView) view.findViewById(R.id.brand_name);
