...
/**
 * Created by chenc on 2017/11/20.
 */
...
//    private ImageButton mBtn;
    ...
    public SwitchImage(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mContext = context;
        lastItemToNextOrStop = true;

        LayoutInflater.from(context).inflate(R.layout.item_banner_guide, this, true);
...
//        });
    ...
    private View initDot() {
        return LayoutInflater.from(mContext).inflate(R.layout.item_banner_dot, null);
    }
...
//            }
    ...
    private View initView(int res) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.item_banner_image, null);
